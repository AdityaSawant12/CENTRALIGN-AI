    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-6">
            <div className="glass rounded-2xl p-8 w-full max-w-md animate-fade-in">
                <h1 className="text-3xl font-bold mb-2 gradient-text text-center">Create Account</h1>
                <p className="text-gray-400 text-center mb-8">Start generating AI-powered forms</p>
